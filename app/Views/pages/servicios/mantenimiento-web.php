...
<section class="service-mant-intro">
    <div class="container">
...
<section class="service-mant-features">
    <div class="container">
        <div class="desc-feature">
            <div class="title-caption">
                Features
            </div>
            <h2>¿Qué incluye el mantenimiento de tu sitio WordPress?</h2>
            <p>Muchos despachos invierten en páginas web que solo están allí, pero no generan ni confianza ni clientes.</p>
        </div>
        <div class="features">
            <picture>
...
<section class="service-mant-negocio">
    <div class="container">
        ...
        <div class="intro-text">
            ...
            <p>Un sitio web desactualizado puede presentar errores, dejar de funcionar, ser hackeado o perder posiciones en buscadores. Esto impacta directamente tus ventas, la confianza de tus usuarios y la imagen de tu marca. El mantenimiento web no es un gasto: <b>es la protección del activo digital más importante de tu negocio.</b></p>
            <ul>
                <li>Pérdida de ventas por caídas del sitio</li>
                <li>Riesgos de seguridad y hackeos</li>
                <li>Lentitud y mala experiencia de usuario</li>
                <li>Caída en el posicionamiento SEO</li>
                <li>Tiempo perdido tratando de resolver problemas técnicos</li>
            </ul>
        </div>
    </div>
</section>

<section class="service-mant-process">
    <div class="container">
        <div class="desc-feature">
            <div class="title-caption">
                NUESTRO PROCESO
        ...
        <div class="features">
            <div class="features-grid">
                <div class="feature-card">
                    ...
                    <h3>Diagnóstico inicial sitio</h3>
                ...
                <div class="feature-card">
                    ...
                    <p>Preparamos tu sitio para prevenir riesgos.</p>
                </div>
                <div class="feature-card">
                    <div class="title-caption">
                        03.
                    </div>
                    <h3>Mantenimiento mensual programado</h3>
                    <p>Actualizaciones, optimización y revisión permanente.</p>
                </div>
                <div class="feature-card">
                    <div class="title-caption">
                        04.
                    </div>
                    <h3>Soporte y mejoras continuas</h3>
                    <p>Atención a incidentes y ajustes cuando lo necesites.</p>
                </div>
            </div>
        </div>
    </div>
...
<!-- <section class="service-mant-benefits">
    <div class="container">
        <h2>Beneficios del mantenimiento profesional</h2>
        <ul class="benefits-list">
            <li>Mayor seguridad y protección contra hackeos</li>
            <li>Mejor rendimiento y velocidad de carga</li>
            <li>Menos tiempo de inactividad</li>
            <li>Mejor posicionamiento en buscadores (SEO)</li>
            <li>Tranquilidad para enfocarte en tu negocio</li>
            <li>Ahorro de tiempo y recursos</li>
        </ul>
    </div>
</section>

<section class="service-mant-cta">
    <div class="container">
        <h2>¿Listo para mantener tu sitio en perfecto estado?</h2>
        <p>Contáctanos para conocer nuestros planes de mantenimiento web</p>
        <a href="<?= URL_PATH ?>contacto" class="cta-green">Solicitar información</a>
    </div>
</section> -->
        ...
        <ul class="faq-list">
            ...
            <li class="faq-item">
                ...
                <div class="faq-answer">
                    ...
                    <ul>
                        <li>Pérdida de velocidad, lo que impacta la experiencia del usuario.</li>
                        <li>Riesgos de seguridad, dejando el sitio expuesto a ataques o malware.</li>
                        <li>Caídas del sitio o periodos en los que no está disponible.</li>
                        <li>Fallos visuales o funcionales, como secciones que no cargan, imágenes rotas o menús que dejan de funcionar.</li>
                    </ul>
...
<section class="banner-cta">
    <div class="container">
        <h2 class="dark">Tu sitio web es clave para tu negocio. <span class="light">Cuídalo</span></h2>
        <p>Evita problemas técnicos, pérdida de ventas y riesgos de seguridad. Nosotros nos encargamos del mantenimiento de tu sitio mientras tú te enfocas en crecer tu negocio.</p>
        <a href="<?= URL_PATH ?>contacto" class="primary-action">Solicitar información</a>
    </div>
</section>